...
% counters
\def\resetvolume#1{\setcounter{part}{#1}}
\def\resetchapter#1{\setcounter{chapter}{#1}}
\def\resetsection#1{\setcounter{section}{#1}}
\def\resetsubsection#1{\setcounter{subsection}{#1}}
\def\resetsubsubsection#1{\setcounter{subsubsection}{#1}}
