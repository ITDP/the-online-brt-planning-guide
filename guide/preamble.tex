...
\newcommand{\manusmallimgtable}[4]{
	\marginpar{
		\noindent\raggedright\footnotesize\bfseries\color{volume\thepart}\sffamily Table \thechapter.#2. #3\par
		\noindent\includegraphics[width=49mm]{#1}
	}
}
...
\newcommand{\tabletitle}[2]{{\vskip 2.25mm plus 2.25mm\noindent\bfseries\color{volume\thepart}\sffamily Table \thechapter.#1. #2} \vskip 2.25mm plus 2.25mm }
